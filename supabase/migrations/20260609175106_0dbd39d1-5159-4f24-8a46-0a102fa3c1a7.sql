...
-- verify_admit_card and verify_certificate are intentionally public read-only verifiers — re-grant to anon
GRANT EXECUTE ON FUNCTION public.verify_admit_card(text) TO anon;
